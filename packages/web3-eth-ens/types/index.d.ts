...
import { PromiEvent, TransactionConfig, TransactionReceipt } from 'https://raw.githubusercontent.com/ntrotner/web3-deno/main/packages//web3-core/types/index.d.ts';
import { TransactionRevertInstructionError } from 'https://raw.githubusercontent.com/ntrotner/web3-deno/main/packages//web3-core-helpers/types/index.d.ts';
import { Eth } from 'https://raw.githubusercontent.com/ntrotner/web3-deno/main/packages//web3-eth/types/index.d.ts';
import { Contract } from 'https://raw.githubusercontent.com/ntrotner/web3-deno/main/packages//web3-eth-contract/types/index.d.ts';
